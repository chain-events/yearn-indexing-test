...
import type { DebtPurchased, DebtUpdated, Deposit, GovernanceTransferred, NewDebtAllocator, ReferralDeposit, RoleSet, RoleStatusChanged, Shutdown, StakingPoolAdded, StrategyChanged, StrategyReported, ThreeJaneBorrowerMarket, ThreeJanePaymentCycle, TimelockEvent, Transfer, UpdateAccountant, UpdateAutoAllocate, UpdateDefaultQueue, UpdateDepositLimit, UpdateDepositLimitModule, UpdateFutureRoleManager, UpdateKeeper, UpdateMaxAcceptableBaseFee, UpdateMaxDebtUpdateLoss, UpdateMinimumChange, UpdateMinimumTotalIdle, UpdateMinimumWait, UpdateProfitMaxUnlockTime, UpdateRoleManager, UpdateStrategyDebtRatios, UpdateUseDefaultQueue, UpdateWithdrawLimitModule, UpdatedMaxDebtForStrategy, V2Deposit, V2EmergencyShutdown, V2FeeReport, V2LockedProfitDegradationUpdated, V2NewPendingGovernance, V2Registry2NewVault, V2RegistryNewExperimentalVault, V2RegistryNewVault, V2StrategyAdded, V2StrategyAddedToQueue, V2StrategyHarvested, V2StrategyMigrated, V2StrategyRemovedFromQueue, V2StrategyReported, V2StrategyRevoked, V2StrategyUpdateDebtRatio, V2StrategyUpdateMaxDebtPerHarvest, V2StrategyUpdateMinDebtPerHarvest, V2StrategyUpdatePerformanceFee, V2Sweep, V2TradeAddressEvent, V2TradeDisabled, V2TradeEnabled, V2UpdateDepositLimit, V2UpdateGovernance, V2UpdateGuardian, V2UpdateManagement, V2UpdateManagementFee, V2UpdatePerformanceFee, V2UpdateRewards, V2UpdateWithdrawalQueue, V2Withdraw, V2WithdrawFromStrategy, V3AccountantVaultChanged, V3RegistryNewEndorsedVault, V3RoleManagerAddedNewVault, V3RoleManagerFactoryNewProject, V3SplitterNewSplitter, V3StrategyReported, V3VaultFactoryNewVault, V3YieldSplitterNewYieldSplitter, VeyfiGaugeRegistered, VotingEscrowCreated, Withdraw } from "envio";
